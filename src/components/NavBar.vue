...
<nav class="relative bg-[#2C3540] border-b border-[#404850]">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <el-dropdown class="relative ml-3">
          <button class="relative flex rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
            ...
            <img src="../assets/greatest.jpg" alt="" class="size-8 rounded-full bg-gray-800 outline -outline-offset-1 outline-white/10" />
          </button>
  ...
  <el-disclosure id="mobile-menu" hidden class="block sm:hidden">
    <div class="space-y-1 px-2 pt-2 pb-3">
      <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
      <RouterLink to="/" class="nav-link block">Home</RouterLink>
      <RouterLink to="/games" class="nav-link block">Games</RouterLink>
      <RouterLink to="/about" class="nav-link block">About</RouterLink>
      <RouterLink to="/contact" class="nav-link block">Contact</RouterLink>
    </div>
  </el-disclosure>
</nav>
